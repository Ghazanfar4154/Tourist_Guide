...
class PlaceDisplay extends StatefulWidget {
  PlaceDisplay({required this.placeType});
  final PlaceType placeType;

  @override
  State<PlaceDisplay> createState() => _PlaceDisplayState();
}

class _PlaceDisplayState extends State<PlaceDisplay> {
  late Future<List<PlacesModel>> places;
  ...
  void initState() {
    ...
    places = PlaceHandler.fetchPlaces(widget.placeType);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.placeType.name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
        // actions: [
        //   IconButton(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            List<PlacesModel>? placesList = snapshot.data as List<PlacesModel>?;
                  ...
                  return GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_){
                        return DetailsPage(place: placesList[index],placeType: widget.placeType,temp: tempList[index],);
                      }));
                    },
                      child: _buildAnimatedPlaceCard(context, placesList[index], index, placesList.length));
                },
              );
            }
            else {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          if((double.parse(place.rating.toStringAsFixed(1))>0))
                            Row(
                            children: [
