...
class _NavigationScreenState extends State<NavigationScreen> {
  ...
  getDirections(LatLng dst) async {
    ...
    List<dynamic> points = [];
    PolylineRequest preqest = PolylineRequest(origin: PointLatLng(curLocation.latitude, curLocation.longitude), destination: PointLatLng(dst.latitude, dst.longitude), mode: TravelMode.driving);
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        googleApiKey: 'AIzaSyA0iVgHPeVuELmaxyiW5XU8OsHqD8NuxG8',
      request: preqest
    );
